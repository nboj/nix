{ pkgs, ... }:
{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    input = {
	  ...
	  kb_options = "grp:win_space_toggle";  # or alt_shift_toggle, etc.
...
# Waybar managed by systemd, starts with the session and restarts if it dies.
systemd.user.services.waybar = {
  Unit = {
    Description = "Waybar status bar";
    PartOf = [ "graphical-session.target" ];
    # If you have it (UWSM provides it), this makes ordering even safer:
    After = [
